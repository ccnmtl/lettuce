...
def test_output_of_table_with_success_colorless():
    ...
    assert_stdout_lines(
        "\n"
        "特性: 步骤中包含表格             # tests/functional/language_specific_features/zh-CN/success/table.feature:3\n"
        ...
        "    如果 输入数据如下:           # tests/functional/language_specific_features/zh-CN/success/table_steps.py:6\n"
        "      | id | 名称   |\n"
        "      | 12 | 名称一 |\n"
        "      | 64 | 名称二 |\n"
        "\n"
